...
Also, under each section I have mentioned some `CHECKS` that would help in making sure you are on the right track.
...
* To check whether whether the installation was sucessful :
    ...
    + This creates a docker container and will give details about your GPU
